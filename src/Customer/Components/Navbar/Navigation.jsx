...
import { getUserProfileAction, logOutAction } from '../../../State/Auth/Action'
  ...
  return (
    <div className="bg-white z-50 relative">
      ...
      <header className="relative bg-white">
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                {!auth.user? <Button onClick={handleModalOpen} className='text-sm font-medium text-gray-700 hover:text-gray-800'>
                  Sign In
                </Button>
                :
        ...
        <AuthModal handleClose={handleModalClose} open={modalOpen}/>
